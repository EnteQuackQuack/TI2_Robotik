...
> | --- | --- | --- | --- | --- |
> | P-Regler | $a(t)=KP⋅Δ(t)a(t)$ | Schnelle Sprungantwort. | Bleibende Regelabweichung bei P-Strecken. | Strecken ohne Ausgleich (I-Strecken). |
> | I-Regler | $a(t)=KI⋅∫0tΔ(t) dta(t)$ | Kompensiert Regelabweichung vollständig. | Langsame Reaktion, Überschwingen. | P-Strecken (mit Ausgleich). |
> | D-Regler | $a(t)=KD⋅dΔ(t)dta(t)$ | Schnelle Reaktion auf Änderungen. | Keine Kenntnis der Regelabweichung (allein nicht einsetzbar). | Kombination mit P/I. |
> | PI-Regler | $a(t)=KP⋅Δ(t)+KI⋅∫0tΔ(t) dta(t)$ | Kompensiert bleibende Abweichung. | Überschwingen möglich. | P-Strecken. |
> | PD-Regler | $a(t)=KP⋅Δ(t)+KD⋅dΔ(t)dta(t)$ | Schnelle Reaktion + Dämpfung. | Keine Kompensation bleibender Abweichung. | Strecken mit Verzögerung. |
> | PID-Regler | $a(t)=KP⋅Δ(t)+KI⋅∫0tΔ(t) dt+KD⋅dΔ(t)dta(t)$ | Allrounder für die meisten Strecken. | Komplexere Einstellung. | Standardlösung für die meisten Fälle. |
